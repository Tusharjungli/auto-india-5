...
export const metadata = {
  ...
  openGraph: {
    ...
    siteName: 'Auto India',
    images: [{ url: '/images/og-hero.jpg', width: 1200, height: 630, alt: 'Auto India Spare Parts' }],
    type: 'website',
  },
};
...
export default async function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang="en" className={theme === 'dark' ? 'dark' : ''}>
      <body className={`${manrope.variable} font-sans bg-[var(--bg)] text-[var(--text)] transition-colors`} suppressHydrationWarning={true}>
        <Providers>
          <NavbarWrapper />
          {children}
          <Footer />
