  ...
  return (
    <nav className="sticky top-0 z-50 flex items-center justify-between px-6 py-4 bg-[var(--bg)] text-[var(--text)] shadow-md border-b border-gray-300 dark:border-gray-700 backdrop-blur-md transition-colors">
      ...
      <ul className="flex items-center space-x-6 text-sm font-medium">
        {isAdmin ? (
          <>
            <li><Link href="/admin" className="hover:text-gray-500 transition">Admin Dashboard</Link></li>
            <li><Link href="/admin/products" className="hover:text-gray-500 transition">Manage Products</Link></li>
            <li><Link href="/admin/feedback" className="hover:text-gray-500 transition">Manage Feedback</Link></li>
          </>
        ) : (
          <>
        ...
        {user ? (
          <>
            {!isAdmin && <li><Link href="/dashboard" className="hover:text-gray-500 transition">My Orders</Link></li>}
